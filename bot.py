...
import handlers.command.start , handlers.command.balance, handlers.transactions
...
def main() -> None:
    ...
    try:
        ...
        # application.add_handler(CommandHandler('pending_transactions', handlers.transactions.show_pending_transactions))

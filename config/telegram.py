...
ADMIN_CHAT_ID = os.getenv('ADMIN_CHAT_ID')  # Optional: group/channel/chat ID for admin notifications
...
def validate_tokens():
    ...
    if not TRANSACTIONS_BOT_TOKEN or TRANSACTIONS_BOT_TOKEN.startswith('YOUR_BOT_TOKEN'):
        raise ValueError("Please set TRANSACTIONS_TELEGRAM_BOT_TOKEN environment variable")

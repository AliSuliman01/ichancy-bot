     ...
     if db:
          ...
          if vlueValidate(value):
               ...
               if balanceValidate(value , balance):
                    ...
                    transfer_num = transfeer.get('phone_number')
                    ...
                    await context.bot.send_message(** withdraw_message(telegram_id=telegram_id,transfeer_id=transfeer_id,provider_type=provider_type,telegram_username=telegram_username,value=value ,transfeer_date=transfeer_date , transaction_id = transaction_id , TAX = TAX,withdraw_number=phone_number , transfer_num = transfer_num , text=message))  
               else:

    ...
    try:
        ...
        cursor.execute("""
                CREATE TABLE IF NOT EXISTS settings (
                    ...
                    admin_telegram_id VARCHAR(255),
                    parent_id VARCHAR(255),
                    exchange_rate DECIMAL(10, 2) DEFAULT 1.00,
                    admin_chat_id VARCHAR(255),
                    telegram_bot_token VARCHAR(255),
                    transactions_telegram_bot_token VARCHAR(255),
                    telegram_channels VARCHAR(255),
                    telegram_groups VARCHAR(255),
                    bot_name VARCHAR(255),
                    cookie_from_group_id VARCHAR(255),
                    crypto_deposit_group VARCHAR(255),
                    crypto_withdraw_group VARCHAR(255),
                    bemo_deposit_group VARCHAR(255),
                    bemo_withdraw_group VARCHAR(255),
                    syriatel_deposit_group VARCHAR(255),
                    syriatel_withdraw_group VARCHAR(255),
                    shamcash_deposit_group VARCHAR(255),
                    shamcash_withdraw_group VARCHAR(255),
                    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
